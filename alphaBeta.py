...
# Removed import random since it's no longer needed
...
leaf_values = [1, 15, 41, 16, 17, 46, 43, 27, 7, 29, 15, 27, 19, 31, 34, 24]
...
def create_tree(node, current_depth, max_depth=4):
    if current_depth < max_depth:
        ...
        node.value = leaf_values.pop(0)  # Assign fixed values in order
    return node
